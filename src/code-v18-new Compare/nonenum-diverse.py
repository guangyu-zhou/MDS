...
def main(input_file):
	...
	# input_file = "/Users/DavidZhou/Google Drive/15sp/research/ma/code/human/process_link_scores.txt"
	global max_gain
	global D
	...
	fout = open("./result-nonenum-sieve/" +input_file.split("/")[-1].split(".")[0] +"-d" +str(theta) + "-k" +str(k) + ".txt", "w+")


	print "========================="
	print "theta", theta, "top-k", k 
	# print "========================="
	coverage_set = set()
	max_dense =  S[maxV]
	...
	print "coverage",maxF
	print "# MDS with len >= 3 ", len(max_dense)

		# if(len(elem[0]) >= 3 and len(elem[0]) <=8 ):


# k_theta_pairs = [(5, 0.8), (34, 0.7),(89, 0.6),(153, 0.5), (173, 0.4), (196, 0.3)]
# theta_k_pairs = [(0.9, 79), (0.8, 111), (0.7, 139), (0.6, 183)] # krogran-core
# theta_k_pairs = [(0.5, 240)]
# theta_k_pairs = [(0.9, 82),(0.8, 112), (0.7, 142), (0.6, 200), (0.5, 257)] # krogan-extended
theta_k_pairs = [(0.9, 100), (0.8, 117), (0.7, 128), (0.6, 136), (0.5, 169)] #collin

for theta,k in	theta_k_pairs:
# k = 89
# theta = 0.6
	min_elem_output = 1
	# print "Running default... k=",k, "theta=",theta
